...
import ShippingLineForm from '../components/ShippingLineForm';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="sm:flex sm:items-center sm:justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Shipping Lines</h1>
          <p className="mt-2 text-gray-600">
            Manage shipping line partners and contacts
          </p>
        </div>
        <button
          onClick={() => {
      ...
      {loading ? (
        <div className="text-center py-12">
          ...
          <p className="mt-4 text-gray-600">Loading shipping lines...</p>
        </div>
      ) : (
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          ...
          {filteredEntities.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">No shipping lines found</h3>
              <p className="mt-1 text-sm text-gray-500">
                Get started by creating a new shipping line
              </p>
            </div>
          )}
        </div>
